...
class SP_Widget_Text_Bidsketch extends WP_Widget {

	function __construct() {
		$widget_ops = array('classname' => 'sp-widget-text-bidsketch', 'description' => __('Arbitrary text or HTML with a Bidsketch look.'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('text_bidsketch', __('Bidsketch Text'), $widget_ops, $control_ops);
	}
