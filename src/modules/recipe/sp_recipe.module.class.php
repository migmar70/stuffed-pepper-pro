...
class SP_RecipeModule extends SP_Module  {

	public function __construct( $sp ) {
		parent::__construct( $sp, __FILE__, 'recipe' );

		$this->page_title = 'Recipes';
		$this->menu_label = 'Recipes';
		$this->menu_slug = 'stuffed-pepper-recipe';
	}
	...
	public function register_post_types(){
		...
		$post_type_args = array(
			'description' => 'Stuffed Pepper Recipes',
			'public' => false,
	...
	public function add_submenu_page( $adminmenu ){
		...
		$this->page_title = $adminmenu->page_title.' - Recipes';
		$this->menu_label = 'Recipe';
		$this->menu_slug = $adminmenu->menu_slug.'-recipe';
	...
	public function list_view(){
		...
		$config = array(
	        ...
	        'labels' => array (
	                'singular' => __( 'Recipe', 'stuffed-pepper' ),
	                'plural' => __( 'Recipes', 'stuffed-pepper' )
	            ),
	        ...
	        'columns' => array( 
	            'post_title'    => array( 'title' => __( 'Recipe', 'stuffed-pepper' ),     'callback' => array( $this, 'render_column'), 'sort' => true ),
	        ),
		...
		$this->view( 'recipes', array( 'list_table' => $list_table ) );

		return true;
	}

	public function edit_view(){
		$this->view( 'recipe', $this->result );
		return true;
	}
