...
class SP_MailchimpModule extends SP_Module  {

	public function __construct( $sp ) {
		parent::__construct( $sp, __FILE__, 'mailchimp' );
	}
	...
	public function register_post_types(){
		...
		$this->post_type = 'sp_mailchimp';

		$post_type_args = array(
			'description' => 'Stuffed Pepper Mailchimps',
			'public' => false,
			'rewrite' => false,
			'supports' => false
		);
	...
	public function add_submenu_page( $adminmenu ){
		...
		$this->page_title = $adminmenu->page_title.' - Mailchimp';
		$this->menu_label = 'Mailchimp';
		$this->menu_slug = $adminmenu->menu_slug.'-mailchimp';
	...
	public function list_view(){
		...
		$config = array(
	        ...
	        'labels' => array (
	                'singular' => __( 'Mailchimp', 'stuffed-pepper' ),
	                'plural' => __( 'Mailchimps', 'stuffed-pepper' )
	            ),
	        ...
	        'columns' => array( 
	            'post_title'    => array( 'title' => __( 'Mailchimp', 'stuffed-pepper' ),     'callback' => array( $this, 'render_column'), 'sort' => true ),
	        ),
		...
		$this->view( 'mailchimps', array( 'list_table' => $list_table ) );

		return true;
	}

	public function edit_view(){
		$this->view( 'mailchimp', $this->result );
		return true;
	}
